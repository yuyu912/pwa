const SHELL = "wardrobe-local-v15";
const ASSETS = ["./", "./app.css?v=10", "./local-app.js?v=14", "./weather-rules.js?v=1", "./analysis-rules.js?v=2", "./runtime-utils.js?v=3", "./region-search.js?v=1", "./ai-result-utils.js?v=2", "./image-analysis-utils.js?v=1", "./local-ai-worker.js?v=8", "./china-regions.min.json?v=1", "./manifest.webmanifest", "./icon.svg", "./wardrobe-home-hero-v2.png", "./today-outfit-v2.png", "./home-icons-v2.png", "./weather-states-v3.png"];
